...
Template['components_seller_po_details'].helpers({
	"getRFQDetails" : function(){
	 return rfqDetails.list();
	},
});

Template['components_seller_po_details'].onRendered(function(){
...
Template['components_seller_po_details'].events({
